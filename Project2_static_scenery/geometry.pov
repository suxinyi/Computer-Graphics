...
union {
    ...
    text { ttf "arial.ttf", "Geometry", 0.5, 0.0
       texture{ pigment{ color rgb<1,1,1>*1.3 } 
                finish { phong 0.1 }
              }
       scale<1.75,2.5,2.25>*0.6
       translate<-0.70,0.5,8.50 > 
       rotate -y*25
      }
